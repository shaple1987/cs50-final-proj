<?php
    ...
    /**
    * Renders page title and button text on "next.php".
    */
    function next_trial()
    {
        if ($_SESSION["seq"] < $_SESSION["N"])
        {
            $title = "Start Next Trial";
            $buttontext = "Start Next Trial";
        }
        else
        {
            $title = "Test Completed";
            $buttontext = "Congratulations!  You completed the test.  Click here to return to homepage.";
        }
        return ["title" => $title, "buttontext" => $buttontext];
    }
